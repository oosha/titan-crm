...
window.TITAN_PERSONAS.joanna = {
  ...
  mailbox: { threads: [
    ...
    { id: 'thread-lucy-thanks', from: 'Lucy Park', email: 'lucy.park@gmail.com', subject: 'Thank you for my bouquet frame', date: 'Today', unread: true, messages: [
      { dir: 'received', when: 'Today', body: ['Hi Joanna,', 'I picked up my bouquet frame yesterday and wanted to say thank you. It is even more beautiful in person, and I cannot stop looking at it.', 'Lucy'] }
    ] },
    { id: 'thread-square-payout', from: 'Square', email: 'notifications@squareup.com', subject: 'Your Square payout is on its way', date: 'Yesterday', unread: false, messages: [
      { dir: 'received', when: 'Yesterday', body: ['Hi Joanna,', 'Your latest Square payout is on its way to your linked bank account. It should arrive within one to two business days.', 'Square'] }
    ] },
    { id: 'thread-sarah-booking', from: 'Sarah Chen', email: 'sarah.chen@outlook.com', subject: 'Booking confirmation and bouquet drop-off', date: '10 Aug', unread: false, messages: [
